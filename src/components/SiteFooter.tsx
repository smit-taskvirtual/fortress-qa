      ...
      <div className="container-x py-16 grid gap-12 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link to="/speaking" className="text-muted-foreground hover:text-foreground">Public Speaking</Link></li>
            <li><Link to="/media-kit" className="text-muted-foreground hover:text-foreground">Media Kit</Link></li>
